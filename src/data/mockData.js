...
export const PRODUCTS = [
  ...
  },
  {
    ...
    description:
      "Specially engineered using optimized wood veneer layers bonded with fortified synthetic adhesive. Delivers incredible physical strength, high load-bearing capability, and outstanding durability for home furniture frameworks.",
    basePrice: 98,
    unit: "sq.ft",
    thicknesses: ["6mm", "9mm", "12mm", "16mm", "19mm"],
    rating: 4.8,
  ...
  },
  {
    id: "ply-bwp-710",
    category: "plywood",
    name: "BWP 710 Plywood",
    tagline: "15 Years Warranty  Grade Waterproof Plywood",
    description:
      "A heavy-duty marine grade plywood designed specifically for kitchens, washrooms, and high-humidity environments. Certified waterproof with high resistance against decay and fungal attacks.",
    basePrice: 110,
    unit: "sq.ft",
    thicknesses: ["6mm", "9mm", "12mm", "16mm", "19mm"],
    rating: 4.8,
    ...
    specs: {
      "Core Wood": "Gurjan & Mixed Hardwood Core",
      Resin: "Phenol Formaldehyde Glue",
    ...
    features: [
      ...
      "High Moisture Immunity",
      "Superior Calibrated Board",
    ],
  },
  {
    id: "ply-eg-bwr-303",
    category: "plywood",
    name: "EG BWR 303",
    tagline: "Boiling Water Resistant IS:303 Grade Plywood",
    description:
      "Superior weather and water-resistant property. Specially formulated to counter humidity fluctuations, making it ideal for semi-exposed wood panelings, kitchen storage, and dining room sets.",
    basePrice: 85,
    unit: "sq.ft",
    thicknesses: ["4mm", "6mm", "9mm", "12mm", "16mm", "19mm"],
    rating: 4.7,
    reviews: 112,
    image:
      "https://images.unsplash.com/photo-1610557892470-76d747eed00b?auto=format&fit=crop&q=80&w=800",
    specs: {
      "Core Wood": "Dense Broad-Leaf Timbers",
      Resin: "Fortified Melamine Urea Formaldehyde",
      "Glue Shear Strength": "> 1100 N",
      "Moisture Content": "9% - 13%",
      Warranty: "8 Years Certified Warranty",
    },
    features: [
      "8 Years Warranty",
      "Boiling Water Resistant (BWR)",
      "Borer & Fungus Resistant",
      "Uniform Calibrated Density",
    ],
  },
  {
    id: "ply-vito-bwr-303",
    category: "plywood",
    name: "Vito BWR 303",
    tagline: "High Performance Boiling Water Resistant Interior Plywood",
    description:
      "An exceptionally reliable construction grade plywood that stands strong against continuous humidity. Combines a sturdy hardwood composite core with fortified moisture protection.",
    basePrice: 80,
    unit: "sq.ft",
    thicknesses: ["6mm", "9mm", "12mm", "15mm", "18mm"],
    rating: 4.6,
    reviews: 89,
    image:
      "https://images.unsplash.com/photo-1513519245088-0e12902e5a38?auto=format&fit=crop&q=80&w=800",
    specs: {
      "Core Wood": "Eucalyptus & Mixed Poplar Hardwood",
      Resin: "Melamine Urea Formaldehyde Glue",
      "Glue Shear Strength": "> 1050 N",
      "Moisture Content": "9% - 12%",
    },
    features: [
      "Excellent Structural Stiffness",
      "Termite Protection Shield",
  ...
  },
  {
    ...
    description:
      "A commercial-grade moisture resistant masterpiece. Specially treated to repel pests, this plywood provides uniform flatness and flawless laminate adhesion properties for wardrobes and ceilings.",
    basePrice: 68,
    unit: "sq.ft",
    ...
    image:
      "https://images.unsplash.com/photo-1541123437800-1bb1317badc2?auto=format&fit=crop&q=80&w=800",
    specs: {
      "Core Wood": "Eucalyptus & Softwood blend",
      Resin: "Fortified Urea Formaldehyde",
      "Glue Shear Strength": "> 1000 N",
      "Moisture Content": "10% - 13%",
    },
    features: [
      "Termite Borer Resistance Layer",
      "Zero Warpage Under Tension",
  ...
  },
  {
    ...
    category: "plywood",
    name: "Vito MR 303",
    tagline: "Reliable Commercial Interior Plywood",
    description:
      "Optimized for elegant and pocket-friendly indoor structures, dry partitions, wardrobe backpanels, wall panelings, and generic commercial interior decoration projects.",
    basePrice: 60,
    unit: "sq.ft",
    ...
    image:
      "https://images.unsplash.com/photo-1533090161767-e6ffed986c88?auto=format&fit=crop&q=80&w=800",
    specs: {
      "Core Wood": "Premium Poplar Core wood",
      Resin: "Urea Formaldehyde adhesive",
      "Glue Shear Strength": "> 950 N",
      "Moisture Content": "10% - 14%",
    },
    features: [
      "Superb Woodgrain Core Stability",
      "Very Easy Carpenter Cutting",
      "Cost-Efficient Interioring",
    ],
  },
  {
    id: "ply-nc-mr-303",
    category: "plywood",
    name: "NC MR 303",
    tagline: "Standard Budget MR Grade Commercial Plywood",
    description:
      "An extremely cost-effective choice for general woodworking, commercial packaging, false ceiling framework reinforcements, and interior panel supports.",
    basePrice: 55,
    unit: "sq.ft",
    thicknesses: ["4mm", "6mm", "9mm", "12mm", "15mm", "18mm"],
    rating: 4.4,
    ...
    image:
      "https://images.unsplash.com/photo-1513519245088-0e12902e5a38?auto=format&fit=crop&q=80&w=800",
    specs: {
      "Core Wood": "Selected Plantation Timbers",
      Resin: "Commercial Urea Bond",
      "Glue Shear Strength": "> 900 N",
      "Moisture Content": "11% - 14%",
    },
    features: [
      "Extremely Economical",
      "Easy Assembly with Standard Nails",
      "Uniform Board Flatness",
    ],
  },
