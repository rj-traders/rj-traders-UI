...
import centuryVeneer1 from "../assets/centuryply-images/D174_Dyed_Pearl_Slate_Grey.webp";
import centuryVeneer2 from "../assets/centuryply-images/D175_Dyed_Pearl_Marble_White.webp";
import centuryVeneer3 from "../assets/centuryply-images/Dyed_Opal_Grey.webp";
import centuryVeneer4 from "../assets/centuryply-images/NV_D120_dyed_koto_coffee.webp";
import centuryVeneer5 from "../assets/centuryply-images/NV_D171_Blanco_Oak_1.webp";
import centuryVeneer6 from "../assets/centuryply-images/NV_D806_dyed_oak_grey.webp";
import centuryVeneer7 from "../assets/centuryply-images/NV_D830_dyed_chen_chen_light_brown.webp";

// Sharon Veneers Product Images
import sharonVeneer1 from "../assets/sharonply-images/Dibeto.webp";
import sharonVeneer2 from "../assets/sharonply-images/Figured-Eucalyptus.webp";
import sharonVeneer3 from "../assets/sharonply-images/light-american-maple-large.webp";
import sharonVeneer4 from "../assets/sharonply-images/light-anegre-large.webp";
import sharonVeneer5 from "../assets/sharonply-images/light-chestnut-large.webp";
import sharonVeneer6 from "../assets/sharonply-images/light-eucalyptus-large.webp";
import sharonVeneer7 from "../assets/sharonply-images/light-knotty-pine-large.webp";

// Greenply Veneers Product Images
import greenplyVeneer1 from "../assets/greenply-images/AM CHERRY.webp";
import greenplyVeneer2 from "../assets/greenply-images/ANIGRE.webp";
import greenplyVeneer3 from "../assets/greenply-images/BACOTE.webp";
import greenplyVeneer4 from "../assets/greenply-images/CURLY & QUILTED MAPLE.webp";
import greenplyVeneer5 from "../assets/greenply-images/ROASTED BIBOLO.webp";
import greenplyVeneer6 from "../assets/greenply-images/ROASTED FIGURED EUCALYPTUS.webp";
import greenplyVeneer7 from "../assets/greenply-images/ZERICOTE.webp";

// Realply Veneers Product Images
import realplyVeneer1 from "../assets/realply-images/1.5mm Goncalo Alves.webp";
import realplyVeneer2 from "../assets/realply-images/1.5mm Oak Crown.webp";
import realplyVeneer3 from "../assets/realply-images/1.5mm Smoked Larch Crown.webp";
import realplyVeneer4 from "../assets/realply-images/1.5mm Teak Crown.webp";
import realplyVeneer5 from "../assets/realply-images/1.5mm White Ash Crown.webp";
import realplyVeneer6 from "../assets/realply-images/Pommele Eucalyptus.webp";
import realplyVeneer7 from "../assets/realply-images/Pommele Sapeli.webp";
...
export const PRODUCTS = [
  ...
  // Veneers - Century Veneers
  {
    ...
    rating: 4.8,
    reviews: 42,
    image: centuryVeneer1,
    specs: {
      "Wood Species": "Reconstituted Slate Grey",
      "Face Thickness": "0.55mm",
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 29,
    image: centuryVeneer2,
    specs: {
      "Wood Species": "Reconstituted Marble White",
      "Face Thickness": "0.55mm",
      "Backing Layer": "Premium non-woven fleece",
      "Adhesive Class": "E0 Eco-Emission certified",
    },
    features: [
      "Pearlescent high-end wood grain",
      "Uniform color match guaranteed",
      "Ready for clear lacquer or PU coating",
      "Eco-friendly sustainable source",
    ],
  },
  {
    id: "ven-century-opal-grey",
    category: "veneers",
    brand: "century-veneers",
    ...
    rating: 4.7,
    reviews: 35,
    image: centuryVeneer3,
    specs: {
      "Wood Species": "Reconstituted Opal Grey",
      "Face Thickness": "0.55mm",
      "Backing Layer": "Flexible non-woven fleece",
      "Adhesive Class": "E0 Eco-Emission certified",
    },
    features: [
      "Smooth warmth grey aesthetics",
      "Highly resilient to warping and cracking",
      "Zero core gaps",
      "Easy carpentry handling",
    ],
  },
  {
    id: "ven-century-koto-coffee",
    category: "veneers",
    brand: "century-veneers",
    ...
    rating: 4.8,
    reviews: 51,
    image: centuryVeneer4,
    specs: {
      "Wood Species": "Pterygota bequaertii (Koto)",
      "Face Thickness": "0.6mm",
      "Backing Layer": "FSC Certified backing paper",
      "Grain Pattern": "Quarter cut straight grain",
    },
    features: [
      "Deep espresso brown natural tone",
      "Highly stable against temperature expansion",
      "No chemical coloring agents used",
      "Pre-sanded smooth texture",
    ],
  },
  {
    id: "ven-century-blanco-oak",
    category: "veneers",
    brand: "century-veneers",
    ...
    rating: 4.9,
    reviews: 63,
    image: centuryVeneer5,
    specs: {
      "Wood Species": "Quercus robur (White Oak)",
      "Face Thickness": "0.6mm",
      "Backing Layer": "Premium craft paper backing",
      "Grain Pattern": "Crown cut flowy arches",
    },
    features: [
      "Stunning bleached natural white oak logs",
      "Highly durable hard-wearing face",
      "Excellent absorption of wood stains",
      "Splice-matched for continuous panels",
    ],
  },
  {
    id: "ven-century-oak-grey",
    category: "veneers",
    brand: "century-veneers",
    ...
    rating: 4.8,
    reviews: 44,
    image: centuryVeneer6,
    specs: {
      "Wood Species": "Quercus robur (Smoked Oak)",
      "Face Thickness": "0.6mm",
      "Backing Layer": "Flexible non-woven fleece",
      "Grain Pattern": "Exquisite rift straight grain",
    },
    features: [
      "Modern cool grey oak texture",
      "High UV-fade resistance",
      "Uniform moisture level of 8%-10%",
      "Termite resistant backing treatment",
    ],
  },
  {
    id: "ven-century-chen-chen",
    category: "veneers",
    brand: "century-veneers",
    ...
    rating: 4.7,
    reviews: 31,
    image: centuryVeneer7,
    specs: {
      "Wood Species": "Antiaris toxicaria (Chen Chen)",
      "Face Thickness": "0.6mm",
      "Backing Layer": "FSC Certified craft paper",
      "Grain Pattern": "Striped vertical grain",
    },
    features: [
      "Exotic stripes with brilliant golden reflections",
      "Pre-finished ready for quick installation",
      "Saves labor time on matching panels",
      "Eco-certified wood material",
    ],
  },

  // Veneers - Sharon Veneers
  {
    id: "ven-sharon-gold",
    category: "veneers",
    brand: "sharon",
    ...
    image: sharonVeneer1,
    specs: {
      "Face Wood": "Premium Dibeto Exotic",
      "Total Thickness": "4.0mm",
      Backing: "IS:303 Waterproof Gurjan Base",
      Glue: "Melamine Urea Formaldehyde",
    },
    features: [
      "High contrast dark-striped veins",
      "Gurjan plywood backing for absolute flat stability",
      "Anti-termite and borer chemical injection",
      "10 Years Warpage Warranty",
    ],
  },
  {
    id: "ven-sharon-fig-eucalyptus",
    category: "veneers",
    brand: "sharon",
    ...
    image: sharonVeneer2,
    specs: {
      "Face Wood": "Figured Eucalyptus",
      "Total Thickness": "4.0mm",
      Backing: "Premium hardwood core",
      Glue: "Eco-friendly MUF class",
    },
    features: [
      "Quilted 3D wavy wood grain",
      "Incredible light reflection properties",
      "Strictly book-matched for clean symmetry",
      "Perfect for high-gloss PU polish",
    ],
  },
  {
    id: "ven-sharon-maple",
    ...
    image: sharonVeneer3,
    specs: {
      "Face Wood": "American Hard Maple",
      "Total Thickness": "4.0mm",
      Backing: "Calibrated Gurjan backing",
      Glue: "Water resistant MUF",
    },
    features: [
      "Sleek blonde aesthetic for minimalist spaces",
      "Fine and uniform pore structure",
      "Highly resistant to indentation and scratching",
      "Sustainable forestry certification",
    ],
  },
  {
    id: "ven-sharon-anegre",
    category: "veneers",
    brand: "sharon",
    ...
    image: sharonVeneer4,
    specs: {
      "Face Wood": "African Anegre wood",
      "Total Thickness": "4.0mm",
      Backing: "Calibrated hardwood core",
      Glue: "Moisture-free timber overlay class",
    },
    features: [
      "Soft golden straw color",
      "Excellent coverage on expansive surface areas",
      "Smooth grain requires less polish material",
      "No color variation between batches",
    ],
  },
  {
    id: "ven-sharon-chestnut",
    category: "veneers",
    brand: "sharon",
    ...
    image: sharonVeneer5,
    specs: {
      "Face Wood": "European Chestnut",
      "Total Thickness": "4.0mm",
      Backing: "IS:303 Gurjan Plywood",
      Glue: "Melamine Formaldehyde",
    },
    features: [
      "Warm rustic cathedral arches",
      "Exceptional stability under high humidity",
      "Treated against dry-wood borers",
      "Pre-sanded and ready for polycoat",
    ],
  },
  {
    id: "ven-sharon-eucalyptus-light",
    category: "veneers",
    brand: "sharon",
    ...
    image: sharonVeneer6,
    specs: {
      "Face Wood": "Exotic Eucalyptus",
      "Total Thickness": "4.0mm",
      Backing: "Durable mixed-hardwood base",
      Glue: "Melamine fortified adhesive",
    },
    features: [
      "Clean linear vertical grain layout",
      "Highly affordable natural wood option",
      "Eco-certified sustainable plantations",
      "Smooth finish takes matte stains beautifully",
    ],
  },
  {
    id: "ven-sharon-pine",
    ...
    image: sharonVeneer7,
    specs: {
      "Face Wood": "Knotty Pine wood",
      "Total Thickness": "4.0mm",
      Backing: "Calibrated plywood backing",
      Glue: "Urea adhesive class",
    },
    features: [
      "Authentic natural wood knots for rustic touch",
      "Rich amber-to-cream grain gradients",
      "Emits pleasant pine aroma when processed",
      "Perfect for loft styles and cafes",
    ],
  },

  // Veneers - Greenply Veneers
  {
    id: "ven-02",
    category: "veneers",
    brand: "greenply",
    ...
    rating: 4.9,
    reviews: 43,
    image: greenplyVeneer1,
    specs: {
      "Face Wood": "American Black Cherry",
      "Face Thickness": "0.6mm",
      Backing: "Calibrated hardwood core base",
      "Moisture Content": "8% - 10%",
    },
    features: [
      "Timeless reddish-brown luxury gloss appearance",
      "Matures in color with light exposure",
      "Smooth closed-grain timber texture",
      "Perfect for classic study rooms and libraries",
    ],
  },
  {
    id: "ven-greenply-anigre",
    category: "veneers",
    brand: "greenply",
    ...
    rating: 4.8,
    reviews: 39,
    image: greenplyVeneer2,
    specs: {
      "Face Wood": "Exotic Anigre log",
      "Face Thickness": "0.6mm",
      Backing: "Certified Gurjan plywood",
      "Moisture Content": "8% - 11%",
    },
    features: [
      "Silky light gold fibers",
      "Uniform absorption of clear polish",
      "FSC Certified eco-harvesting",
      "Zero surface splitting",
    ],
  },
  {
    id: "ven-greenply-bacote",
    category: "veneers",
    brand: "greenply",
    ...
    rating: 5.0,
    reviews: 18,
    image: greenplyVeneer3,
    specs: {
      "Face Wood": "Cordia elaeagnoides (Bacote)",
      "Face Thickness": "0.65mm",
      Backing: "High-density Gurjan base",
      "Moisture Content": "7% - 9%",
    },
    features: [
      "Dramatic black and golden swirl loops",
      "Heavy density wood face feels premium",
      "Extremely rare exotic wood selection",
      "Ideal for modern bespoke focal pieces",
    ],
  },
  {
    id: "ven-greenply-maple",
    category: "veneers",
    brand: "greenply",
    ...
    rating: 4.9,
    reviews: 29,
    image: greenplyVeneer4,
    specs: {
      "Face Wood": "Quilted Acer saccharum (Maple)",
      "Face Thickness": "0.6mm",
      Backing: "Premium calibrated substrate",
      "Moisture Content": "8% - 10%",
    },
    features: [
      "Stunning curly 3D water ripple shine",
      "Prized by high-end musical instrument makers",
      "Gives incredible luxury polish depth",
      "No knots or defects",
    ],
  },
  {
    id: "ven-greenply-bibolo",
    category: "veneers",
    brand: "greenply",
    ...
    rating: 4.8,
    reviews: 33,
    image: greenplyVeneer5,
    specs: {
      "Face Wood": "Lovoa trichilioides (Bibolo)",
      "Face Thickness": "0.6mm",
      Backing: "Thermotreated backings",
      "Moisture Content": "5% - 8% (Highly stable)",
    },
    features: [
      "Roasted dark cocoa gold hues",
      "High dimensional stability in damp zones",
      "Natural caramelization odor during sanding",
      "Termite and borer immune due to heat treat",
    ],
  },
  {
    id: "ven-greenply-euc-roasted",
    category: "veneers",
    brand: "greenply",
    ...
    rating: 4.9,
    reviews: 41,
    image: greenplyVeneer6,
    specs: {
      "Face Wood": "Figured Eucalyptus (Roasted)",
      "Face Thickness": "0.6mm",
      Backing: "IS:303 Premium Gurjan Base",
      "Moisture Content": "6% - 9%",
    },
    features: [
      "Fiddleback 3D shimmer + dark coffee tone",
      "Excellent behavior under heat and moisture",
      "Ideal for premium office reception walls",
      "Book-matched sheets for symmetrical layout",
    ],
  },
  {
    id: "ven-greenply-zericote",
    category: "veneers",
    brand: "greenply",
    ...
    rating: 5.0,
    reviews: 24,
    image: greenplyVeneer7,
    specs: {
      "Face Wood": "Cordia dodecandra (Zericote)",
      "Face Thickness": "0.65mm",
      Backing: "Premium structural plywood",
      "Moisture Content": "7% - 10%",
    },
    features: [
      "Landscape grain visual lines resemble mountain art",
      "Deep dark brown and olive gold patterns",
      "Smooth finish takes high-gloss clear PU coat",
      "Extremely rare collectible timber log",
    ],
  },

  // Veneers - Realply Veneers
  {
    id: "ven-01",
    category: "veneers",
    brand: "realply",
    ...
    rating: 5.0,
    reviews: 31,
    image: realplyVeneer1,
    specs: {
      "Wood Species": "Astronium fraxinifolium (Tigerwood)",
      "Grain Pattern": "Zebra striped flowy pattern",
      "Face Thickness": "1.5mm (Ultra-thick)",
      "Moisture Level": "8% - 10%",
    },
    features: [
      "1.5mm ultra-thick face allows deep sanding and routing",
      "Vibrant orange-brown base with dark tiger stripes",
      "Heavy load durability for kitchen workstations",
      "Naturally oil-rich wood resists water splashes",
    ],
  },
  {
    id: "ven-realply-oak-crown",
    category: "veneers",
    brand: "realply",
    ...
    rating: 4.8,
    reviews: 48,
    image: realplyVeneer2,
    specs: {
      "Wood Species": "Quercus alba (White Oak)",
      "Grain Pattern": "Crown cathedral arch cut",
      "Face Thickness": "1.5mm (Ultra-thick)",
      "Moisture Level": "8% - 11%",
    },
    features: [
      "Stunning crown arch timber pattern",
      "1.5mm thickness allows distress look texturing",
      "Outstanding mechanical strength",
      "Ready for rustic stains or clear PU seal",
    ],
  },
  {
    id: "ven-realply-larch-crown",
    category: "veneers",
    brand: "realply",
    ...
    rating: 4.9,
    reviews: 37,
    image: realplyVeneer3,
    specs: {
      "Wood Species": "Larix decidua (Larch)",
      "Grain Pattern": "Fumed crown cathedral cut",
      "Face Thickness": "1.5mm (Ultra-thick)",
      "Moisture Level": "7% - 9%",
    },
    features: [
      "Fumed charcoal-carbon textured appearance",
      "Thick face doesn't show background glue lines",
      "High weather and heat resistance",
      "Perfect for luxury entrance doors",
    ],
  },
  {
    id: "ven-realply-teak-crown",
    category: "veneers",
    brand: "realply",
    ...
    rating: 5.0,
    reviews: 58,
    image: realplyVeneer4,
    specs: {
      "Wood Species": "Tectona grandis (Burma Teak)",
      "Grain Pattern": "Burmese gold crown cut",
      "Face Thickness": "1.5mm (Ultra-thick)",
      "Moisture Level": "8% - 10%",
    },
    features: [
      " Burma Teak with high natural oil content",
      "Thick 1.5mm layer looks and feels like solid timber board",
      "Lifetime termite and borer proof warranty",
      "Rich golden glow increases with age",
    ],
  },
  {
    id: "ven-realply-ash-crown",
    category: "veneers",
    brand: "realply",
    ...
    rating: 4.7,
    reviews: 26,
    image: realplyVeneer5,
    specs: {
      "Wood Species": "Fraxinus americana (White Ash)",
      "Grain Pattern": "Ivory crown cut cathedral",
      "Face Thickness": "1.5mm (Ultra-thick)",
      "Moisture Level": "8% - 11%",
    },
    features: [
      "Clean ivory-white wood base",
      "Thick wood fibers absorb dark/pastel stains beautifully",
      "Highly stable against dimensional cracking",
      "Ideal for modern kitchen cabinetry",
    ],
  },
  {
    id: "ven-realply-pom-euc",
    category: "veneers",
    brand: "realply",
    ...
    rating: 4.9,
    reviews: 22,
    image: realplyVeneer6,
    specs: {
      "Wood Species": "Eucalyptus grandis (Pommele)",
      "Grain Pattern": "Dappled pommele water bubbles",
      "Face Thickness": "0.6mm",
      "Moisture Level": "8% - 10%",
    },
    features: [
      "Rare water-drop pommele figure",
      "High shimmer shifts under light directions",
      "Adds three-dimensional depth to surfaces",
      "Best for premium drawer front highlights",
    ],
  },
  {
    id: "ven-realply-pom-sapeli",
    category: "veneers",
    brand: "realply",
    ...
    rating: 4.8,
    reviews: 19,
    image: realplyVeneer7,
    specs: {
      "Wood Species": "Entandrophragma cylindricum (Sapele)",
      "Grain Pattern": "Reddish-brown quilted pommele",
      "Face Thickness": "0.6mm",
      "Moisture Level": "8% - 10%",
    },
    features: [
      "Rich reddish-copper mahogany-like sheen",
      "Pommele figures add visual texture richness",
      "Highly stable against warpage",
      "Perfect for high-end dining table tops",
    ],
  },
